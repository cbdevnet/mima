...
not yet submitted/known bug in the latest releases of either mimasim or mimasm to cb@cbcdn.com are eligible to 
receive one Club Mate each (in Person, in Karlsruhe, at the KIT, in the FSMI) from me ;)
